...
|---|---|---|
| 茶トラ | 人なつこくて食いしん坊。ごはんの時間が近づくと、空の器の前で無言の圧をかける | An orange tabby cat sitting perfectly upright in front of an empty food bowl, one front paw resting on the rim of the bowl, staring straight at the viewer with a silent, heavy, expectant "it is time" look. Round cheeks, slightly plump body. Classic orange tabby features: warm orange coat with darker orange stripes on the forehead (an M-shape), cheeks, legs and ringed tail, cream chin and chest. The bowl is a plain, soft solid color. |
| キジトラ | 「入れそうな所には入る」。小さすぎるぽち袋にも無理やり入って、満足げ | A brown mackerel tabby cat that has squeezed itself into a small paper envelope that is clearly far too small: its head, front paws and tail spill out of the opening while its body stuffs the envelope into a round bulge. Eyes half closed, looking completely satisfied, as if the envelope was made for it. Classic brown tabby features: warm brown-gray coat with dark mackerel stripes, an M-shape on the forehead, ringed tail. The envelope is a plain, soft solid color with no writing. |
...
| 黒猫 | 真っ黒で、丸まると輪郭がわからないただの黒いかたまり。そこに目だけがぱっちり開く | A black cat curled up so tightly that it has become an almost perfect round black ball, no legs or tail visible, with only its two big round golden eyes wide open, peeking out as if it has just heard the treat bag rustle. Tiny pointed ears on top of the ball. Classic black cat features: glossy solid black coat (with a soft highlight so the round shape stays readable), golden-yellow eyes. |
| ハチワレ | 顔を前足にうずめて眠る「ごめん寝」。まるで謝っているように見える | A black-and-white tuxedo cat asleep in the famous "apology sleep" pose: body curled low, forehead pressed flat against the floor between its front paws, as if bowing deeply to say sorry. Classic tuxedo cat features: black coat with a white chest, white paws and a symmetrical white "hachiware" split on the face below the eyes, black ears. |
| サバトラ | 昼間はおとなしいのに、夜中になると突然走り回る「夜中の運動会」 | A silver mackerel tabby cat in the middle of a sudden midnight zoomies sprint: all four legs stretched out mid-gallop, ears pinned back, eyes huge and wild, tail puffed up like a bottle brush. A few simple speed lines behind it show how fast it is going. Classic silver tabby features: pale silver-gray coat with crisp dark gray mackerel stripes, an M-shape on the forehead, ringed tail. |
| スコティッシュ・フォールド | 足を前に投げ出し、人間のように座る「スコ座り」で、くつろぎきった顔 | A scottish fold cat sitting upright like a small person on the floor, back legs stretched straight out in front, round belly showing, front paws resting on its belly, with a calm, completely relaxed, slightly sleepy face, like an old man after a big meal. Classic scottish fold features: small ears folded forward and down, very round head, round eyes, plush coat. Coat color: soft gray-blue. |
| マンチカン | 短い足で、うしろ足だけで立ち上がってまわりを見回す。胴だけが長く伸びる | A munchkin cat standing up on its very short hind legs like a meerkat to look around, body stretched tall, tiny front legs dangling in front of its chest, with a curious, serious, slightly comical face. Classic munchkin features: noticeably short legs with a normal-length body, round face. Coat color: cream with light brown tabby stripes. |
| ラグドール | その名のとおり、抱っこすると力が抜けて、ぬいぐるみのようにぐにゃりとなる | A ragdoll cat draped completely limp over the edge of a small cushion like a soft towel, front half hanging down one side and back half down the other, legs dangling, eyes half closed in total bliss. Classic ragdoll features: large fluffy body, long semi-long coat, bright blue eyes, colorpoint pattern: cream body with darker brown ears, face mask, legs and tail. The cushion is a plain, soft solid color. |
| ブリティッシュ・ショートヘア | まん丸の顔で、落ち着きすぎている。目の前で猫じゃらしを振っても、無表情でまったく反応しない | A british shorthair cat sitting upright like a plump teddy bear, looking straight ahead with a completely neutral, unimpressed expression while a feather toy dangles right in front of its face, entering from the top edge of the canvas on a thin string (no person visible). It does not react at all. Classic british shorthair features: very round face, full round cheeks, small rounded ears, dense plush coat, stocky body, copper-orange eyes. Coat color: blue-gray. |
