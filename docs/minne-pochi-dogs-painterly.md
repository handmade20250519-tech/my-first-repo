...
SUBJECT: ONLY ONE DOG IN THE PICTURE: a single, HUGE great dane, one of the largest dog breeds in the world. There is no second dog, no small dog, no puppy and no reflection anywhere. The dog is LYING DOWN, trying to curl up in a tiny round pet bed made for a small cat. The bed is only about as wide as the dog's head. Only the dog's rear end sits in the bed; everything else spills far out: its long front legs stretch out across the floor, one long back leg hangs over the rim, and its long tail drapes out the other side. Its head rests on the floor well outside the bed, eyes softly closed, looking perfectly content, as if this tiny bed is exactly where it belongs. SCALE (most important): the dog's body is about four times as long as the bed, and each leg is longer than the whole bed is wide. The dog must look enormous and the bed must look ridiculously tiny. For this breed only, do NOT use short stubby legs or a small round body: draw long legs and a long, deep-chested body, while keeping the face cute and simplified. It must clearly be a GREAT DANE, NOT a mastiff: an elegant, lean, athletic giant with a long rectangular head, a flat top of the skull, a clean muzzle with tight lips, NO droopy jowls, NO wrinkles on the face. Natural floppy ears (not cropped), short smooth coat. Coat color: fawn with a black mask. The pet bed is a plain, soft watercolor color.
The humor must feel affectionate and true to life, the kind of moment real owners of this breed instantly recognize. Even in this painterly style, the breed must be clear at a glance. Original design only: do NOT depict any existing character, mascot or brand, and do NOT imitate any specific artist's style.
