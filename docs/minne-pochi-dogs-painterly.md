...
SUBJECT: ONLY ONE DOG IN THE PICTURE: a single, HUGE great dane, one of the largest dog breeds in the world. There is no second dog, no small dog, no puppy and no reflection anywhere. It has squeezed itself into a tiny round pet bed that is only about as big as its own head, the kind of bed made for a small cat. Only its bottom and one elbow actually fit inside the bed, while its long legs, deep chest, long body and big head spill far out over every side, so the bed looks ridiculously small under this giant dog. Despite the obvious mismatch it looks perfectly content and innocent, chin resting on the floor next to the bed, eyes soft and sleepy, as if this is exactly where it belongs. SIZE IS THE JOKE: the dog must look enormous and the bed tiny. For this breed only, do NOT use short stubby legs or a small round body: draw long legs, a long deep-chested body and a big head, while keeping the face cute and simplified. Classic great dane features: very large, tall, sleek body, long legs, broad square muzzle, natural floppy ears (not cropped), short smooth coat. Coat color: fawn with a black mask. The pet bed is a plain, soft watercolor color.
The humor must feel affectionate and true to life, the kind of moment real owners of this breed instantly recognize. Even in this painterly style, the breed must be clear at a glance. Original design only: do NOT depict any existing character, mascot or brand, and do NOT imitate any specific artist's style.
