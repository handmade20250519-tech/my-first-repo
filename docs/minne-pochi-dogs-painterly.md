...
- 表情ははっきり。漫画の記号は、SUBJECTに書いたもの(動きの線など)だけ。顔と頭のまわりには何も描かない
...
TEXT: Write only the breed name "[NAME]" once, in small, simple, neat hand-lettered brush letters in soft dark sumi ink, centered just below the animal, about 6% of the canvas height, on a single line. Spell it exactly: [NAME]. No other text, letters, numbers, seals, signatures or watermarks anywhere.
